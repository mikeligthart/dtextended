...
sub add_to_loop {
  ...
  if ('sequencer') {
    my $sound = q[wah(reverb(asynth(1, $n[$note % @n], $len, $spc,  mseries([1, 0.8441, 0.4358, 3*(1+7), 0.7935, 6, (5+3*4), 4*3*1, 3*6, 1/2], 7, 1, 0.6579), [2, 0.3762, 0.4103, 8, 0.1708, 6*2, 6, 8, 6, 1], [3, 0.02358, 0.74, 3*5, 0.2828, 7, 8*2, 1, -(3/3), 1/2]),1.5,2),0.04323*(7),0.04323*0.7209,0.5)];
