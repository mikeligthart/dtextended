...
sub add_to_loop {
  ...
  if ('sequencer') {
    my $sound = q[reverb(reverb(hipass(backwards(asynth(0.5, $n[$note % @n], $len, $spc, [4, 0.2237, 0.194, 0, 0.4229, 8, (8+2)*3*3*4, 5, -(4/4), 4], [4, 0.3269, 0.7638, 0, 0.01901, 1, (((7+8)+8)+(5+2)), 5, -(1/2), 1], [1, 0.1358, 0.4632, (8+2*5)*4, 0.4617, 4*4*3, (4+1), 8, 5*1, 1/4])),$hirad,$hicyc),1,2),1,1)];
